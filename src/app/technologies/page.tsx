...
export const metadata: Metadata = {
  ...
  description:
    "Complete reference directory of 30+ software engineering technologies: HTML5, CSS3, JavaScript, TypeScript, React 19, Next.js 16, Python 3, SQL, Java 21, C++20, Go, Rust, Kotlin, Swift 6, C# 13, Linux & Ubuntu, DSA, System Design, DevOps, and AI.",
  keywords: [
    ...
    "Kotlin Multiplatform Swift iOS",
  ...
  const techCategories = [
    {
      ...
      description: "Modern browser UI engineering, styling systems, client component architectures, and mobile platforms.",
      technologies: [
        ...
        { name: "Swift & iOS", desc: "Swift 6, SwiftUI declarative UI, and modern async/await", level: "Intermediate", link: "/learn/swift" },
        { name: "Kotlin Multiplatform", desc: "KMP shared business logic across Android and iOS", level: "Intermediate", link: "/learn/kotlin" },
      ],
    },
    {
      category: "Backend & Cloud Microservices",
      icon: <Server className="h-5 w-5 text-emerald-500" />,
      description: "Server runtimes, REST/gRPC API design, microservices, and asynchronous services.",
      technologies: [
        ...
        { name: "C# 13 & .NET 9", desc: "High-throughput Minimal APIs, Entity Framework Core, and Polly", level: "Intermediate → Advanced", link: "/learn/csharp" },
        { name: "Spring Boot (Java)", desc: "Enterprise microservices and cloud backends", level: "Advanced", link: "/learn/java" },
        { name: "Ktor & Kotlin", desc: "Lightweight coroutine-powered microservices", level: "Advanced", link: "/learn/kotlin" },
    ...
    },
    {
      ...
      technologies: [
        ...
        { name: "Kotlin", desc: "Modern JVM language with coroutines and null-safety", level: "Intermediate", link: "/learn/kotlin" },
        { name: "Swift", desc: "Safe, fast, and expressive language by Apple", level: "Intermediate", link: "/learn/swift" },
        { name: "C#", desc: "Type-safe enterprise language for cloud and cross-platform", level: "Intermediate", link: "/learn/csharp" },
    ...
    {
      category: "Operating Systems, DevOps & Cloud",
      icon: <Terminal className="h-5 w-5 text-orange-500" />,
      description: "Operating systems internals, shell automation, container orchestration, and security.",
      technologies: [
        { name: "Linux & Ubuntu", desc: "Kernel architecture, bash automation, systemd, and server hardening", level: "Beginner → Advanced", link: "/learn/linux" },
    ...
    },
    {
      ...
      description: "Relational data engines, SQL, algorithms, and artificial intelligence.",
      technologies: [
  ...
  const jsonLd = {
    ...
    "hasPart": techCategories.map((cat) => ({
      ...
      "itemListElement": cat.technologies.map((t, idx) => ({
        ...
        "position": idx + 1,
        "name": t.name,
        "item": `https://academy.kwas.tech${t.link}`,
      })),
    })),
  };
